  ...
  const process = async () => {
    ...
    try {
      if (mode === "merge") {
        ...
        setResult(bytesBlob(await output.save({ useObjectStreams: false }))); setFilename("pixpromax-merged.pdf");
