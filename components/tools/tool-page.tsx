...
export function ToolPage({ tool, children, steps, faqs, privacyNote = "Your file is processed directly in your browser and is not uploaded to our servers.", fileLabel = "file" }: ToolPageProps) {
  ...
  return (
    <>
      ...
      <section className="tool-workspace shell"><ol className="workflow-guide" aria-label="Workflow overview"><li><b>01</b> Choose {fileLabel}</li><li><b>02</b> Make adjustments</li><li><b>03</b> Download</li></ol>{children}</section>
